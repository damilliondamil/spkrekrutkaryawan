                                                                                    ...
                                                                                    <div class="panel-body">
                                                                                        <table class="table table-light table-striped table-bordered table-hover text-center align-middle" id="myTable">
                                                                                            ...
                                                                                            <tbody>
                                                                                                ...
                                                                                                <?php
                                                                                                if(isset($_POST['rangking'])){
                                                                                                    $sql1 = "INSERT INTO tab_hasil (nama, hasil, tanggal, jam) VALUES ('{$nama}','{$V[$i - 1]}','$date','$time')";
                                                                                                    mysqli_query($koneksi, $sql1);
                                                                                                    echo "<script>alert('Rangking adalah');</script>";
                                                                                                }
                                                                                                }
                                                                                                ?>
                                                                                            </tbody>
                                                                                        ...
                                                                                        <div class="col-md-12  text-right">
                                                                                            ...
                                                                                            <input type="button" name="rangking" value="Keputusan" onclick="sortTable()" class="btn btn-primary">
                                                                                            </form>    
                                                                                        </p>
                                                                                        </div>
                                                                                    </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "INSERT INTO tab_hasil (nama, hasil, tanggal, jam) VALUES ('$nama1','$hasil1','$date','$time')";
    $sql2 = "INSERT INTO tab_hasil (nama, hasil, tanggal, jam) VALUES ('$nama2','$hasil2','$date','$time')";
    $sql3 = "INSERT INTO tab_hasil (nama, hasil, tanggal, jam) VALUES ('$nama3','$hasil3','$date','$time')";
    $koneksi->multi_query($sql1);
}
?>
