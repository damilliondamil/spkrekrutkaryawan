...
<?php include 'navbar.php'; ?>
  ...
  <div class="card-body fw-semibold fs-5">
        ...
        ?>
                        <input type="hidden" name="id" value="<?php echo $kode_otomatis; ?>">
                        ...
                        <div class="input-group">
                        <input type="range" name="k6" oninput="rangeValue3.innerText = this.value" min="1" max="5">
...
(5) >170cm</span>
                        ...
                        <div class="input-group">
                        <input type="number" name="k7" class="input-group text" placeholder="Masukan Jarak Tempuh">
                        </div>
                        </div>
